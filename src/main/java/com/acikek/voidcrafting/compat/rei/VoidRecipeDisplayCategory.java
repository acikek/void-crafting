...
public class VoidRecipeDisplayCategory implements DisplayCategory<VoidRecipeDisplay> {

    @Override
    public Renderer getIcon() {
        return EntryStacks.of(Blocks.END_PORTAL);
    }

    @Override
    public Text getTitle() {
        return new TranslatableText("category.voidcrafting.void_recipe");
    }
